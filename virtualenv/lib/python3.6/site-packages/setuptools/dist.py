...
def get_metadata_version(dist_md):
    if dist_md.long_description_content_type or dist_md.provides_extras:
        ...
        dist_md.maintainer is not None
        or dist_md.maintainer_email is not None
        or getattr(dist_md, "python_requires", None) is not None
    ):
        return StrictVersion("1.2")
    elif (
        dist_md.provides
        or dist_md.requires
        or dist_md.obsoletes
        or dist_md.classifiers
        or dist_md.download_url
    ):
