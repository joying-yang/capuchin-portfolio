...
def _scan_declarative_decorator_stmt(
    ...
    left_node.node.type = api.named_type("__sa_Mapped", [left_hand_explicit_type])
    ...
    cls_metadata.mapped_attr_names.append((left_node.name, left_hand_explicit_type))
        ...
        if isinstance(stmt.type, UnboundType):
            ...
            if stmt.type.name == "Mapped":
                ...
                if (
                    ...
                    and names._type_id_for_named_node(mapped_sym.node) is names.MAPPED
                ):
...
def _scan_for_mapped_bases(
    ...
    while baseclasses:
        ...
        # mixins
        base_decl_class_applied = _scan_declarative_assignments_and_apply_types(
